...
void addPredefinedRecipes(Box<Recipe> recipeBox) {
  recipeBox.addAll([
    Recipe(
      ...
      ingredients: 'Pasta, Egg yolks and whole eggs,Parmigiano reggiano, Guanciale, Pepper',
      instructions: '1. Batons – Cut the guanciale into thick batons. Biting through the golden brown crust into meaty bits of salty guanciale is part of the awesomeness that is carbonara! '
    ...
    Recipe(
      ...
      ingredients: 'Oil/Ghee, Onions, Bone-in, cut up, skinless chicken, Whole spices,Garlic + Ginger,Tomatoes,Yogurt,Rice',
      instructions: '1. Prepare the chicken curry. Prepare the biryani masala (or use store-bought) and marinate the chicken. Start the chicken curry. While the chicken cooks over low heat, make the rice. '
    ...
    Recipe(
      ...
      instructions: '1. Place sushi rice in a fine-mesh strainer and rinse under cold water until the water runs clear (about 3–4 times).'
    ...
    Recipe(
      ...
      instructions: '1. Place the ground beef in a skillet with olive oil.'
